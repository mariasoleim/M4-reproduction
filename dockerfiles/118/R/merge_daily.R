...
DATA_DIR="../data/train/"
m4Info_df=read.csv(paste0("../data/","M4-info.csv"))
...
#NUM_OF_SEEDS=4  #It is equal to the number of seeds in the startup script, (or number of teams of worker processes)
...
#IBIGS=1 #number of complete runs by each executables, so if programs are not interrupted, this should be equal to the constant BIG_LOOP in the c++ code, by default 3.
