...
for (d in datasets){
  ...
  if (d==1){
    frequency = 1; horizon = 6; load("data/RData/Yearly.RData")
  } else if (d==2){
    frequency = 4; horizon = 8; load("data/RData/Quarterly.RData")
  } else if (d==3){
    frequency = 12; horizon = 18; load("data/RData/Monthly.RData")
  } else if (d==4){
    frequency = 52; horizon = 13; load("data/RData/Weekly.RData")
  } else if (d==5){
    frequency = 7; horizon = 14; load("data/RData/Daily.RData")
  } else if (d==6){
    frequency = 168; horizon = 48; load("data/RData/Hourly.RData")
  }
  tsn = length(series)
